...
public class JobController {
    ...
    public String add(Model model, @ModelAttribute JobForm jobForm) {
    ...
    public String add(Model model, @ModelAttribute @Valid JobForm jobForm, Errors errors) {
        ...
        Location aLocation = jobForm.getLocation();
        PositionType aPositionType = jobForm.getPositionType();
        CoreCompetency aSkill = jobForm.getCoreCompetency();
